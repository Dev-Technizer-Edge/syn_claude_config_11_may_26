...
/**
 * Validates a phone number in E.164 or common local formats.
 * Accepts an optional leading +, then 7–15 characters of digits, spaces, hyphens, dots, or parentheses.
 *
 * @param {string} phone
 * @returns {boolean}
 */
